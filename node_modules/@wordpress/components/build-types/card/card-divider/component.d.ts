 ...
 * ```
 */
export declare const CardDivider: import("../../context").WordPressComponent<"hr", Omit<import("@ariakit/react").SeparatorProps, "children" | "as" | "orientation" | "render" | "unstable_system"> & {
