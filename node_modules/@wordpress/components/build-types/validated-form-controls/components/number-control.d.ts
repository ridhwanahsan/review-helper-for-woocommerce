...
export declare const ValidatedNumberControl: import("react").ForwardRefExoticComponent<Omit<Omit<Omit<import("../../input-control/types").InputControlProps, "value" | "max" | "min" | "type" | "required" | "step" | "isDragEnabled"> & {
