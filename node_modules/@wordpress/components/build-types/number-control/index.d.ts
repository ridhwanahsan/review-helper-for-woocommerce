export declare const NumberControl: import("react").ForwardRefExoticComponent<Omit<import("../input-control/types").InputControlProps, "value" | "max" | "min" | "type" | "required" | "step" | "isDragEnabled"> & {
