...
var _HCM6P72Qcjs = require('../__chunks/HCM6P72Q.cjs');


var _N2EWCFNQcjs = require('../__chunks/N2EWCFNQ.cjs');
...
var TagName = "button";
var useTagRemove = _QYN73JUBcjs.createHook.call(void 0, 
  function useTagRemove2({
    ...
    const context = _HCM6P72Qcjs.useTagContext.call(void 0, );
    store = store || context;
    ...
    const setRemoveId = _react.useContext.call(void 0, _HCM6P72Qcjs.TagRemoveIdContext);
    const valueFromContext = _react.useContext.call(void 0, _HCM6P72Qcjs.TagValueContext);
    ...
    const removeOnClickProp = _HAHC3O6Rcjs.useBooleanEvent.call(void 0, removeOnClick);
    ...
    props = {
      ...
      id,
      onClick,
      render: withinTag ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _N2EWCFNQcjs.Role.span, { render: props.render }) : props.render
    };
    return props;
  }
);
var TagRemove = _QYN73JUBcjs.forwardRef.call(void 0, function TagRemove2(props) {
