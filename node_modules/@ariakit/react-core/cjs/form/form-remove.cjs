...
var _AF6NJM6Rcjs = require('../__chunks/AF6NJM6R.cjs');


var _JEHJXSU4cjs = require('../__chunks/JEHJXSU4.cjs');
require('../__chunks/V75WWISJ.cjs');
...
var useFormRemove = _QYN73JUBcjs.createHook.call(void 0, 
  function useFormRemove2({
    ...
    const context = _AF6NJM6Rcjs.useFormContext.call(void 0, );
    store = store || context;
    ...
    props = _JEHJXSU4cjs.useButton.call(void 0, props);
    return props;
  }
);
var FormRemove = _QYN73JUBcjs.forwardRef.call(void 0, function FormRemove2(props) {
