...
var _KADSBCBXcjs = require('../__chunks/KADSBCBX.cjs');


var _GO6DYRNFcjs = require('../__chunks/GO6DYRNF.cjs');
require('../__chunks/4AJ2AADN.cjs');
...
var useTooltipAnchor = _QYN73JUBcjs.createHook.call(void 0, 
  function useTooltipAnchor2({ store, showOnHover = true, ...props }) {
    const context = _KADSBCBXcjs.useTooltipProviderContext.call(void 0, );
    store = store || context;
    ...
    const onMouseEnter = _HAHC3O6Rcjs.useEvent.call(void 0, (event) => {
      onMouseEnterProp == null ? void 0 : onMouseEnterProp(event);
      canShowOnHoverRef.current = true;
    });
    const onFocusVisibleProp = props.onFocusVisible;
    const onFocusVisible = _HAHC3O6Rcjs.useEvent.call(void 0, (event) => {
    ...
    const type = _JRPZ5DZLcjs.useStoreState.call(void 0, store, "type");
    const contentId = _JRPZ5DZLcjs.useStoreState.call(void 0, store, (state) => {
      var _a;
    ...
    props = _GO6DYRNFcjs.useHovercardAnchor.call(void 0, {
      store,
      showOnHover(event) {
...
var TooltipAnchor = _QYN73JUBcjs.forwardRef.call(void 0, function TooltipAnchor2(props) {
