...
var _YUBPT7BYcjs = require('./YUBPT7BY.cjs');
...
function useCollectionRenderer({
  ...
  var _a, _b;
  const context = _YUBPT7BYcjs.useCollectionContext.call(void 0, );
  store = store || context;
  const items = _JRPZ5DZLcjs.useStoreState.call(void 0, 
    store,
  ...
  const baseId = _HAHC3O6Rcjs.useId.call(void 0, props.id);
  const horizontal = orientation === "horizontal";
  const elements = _react.useMemo.call(void 0, () => /* @__PURE__ */ new Map(), []);
  const [elementsUpdated, updateElements] = _HAHC3O6Rcjs.useForceUpdate.call(void 0, );
  ...
  const processVisibleIndicesEvent = _HAHC3O6Rcjs.useEvent.call(void 0, processVisibleIndices);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnScrollProp = _HAHC3O6Rcjs.useBooleanEvent.call(void 0, renderOnScroll);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnResizeProp = _HAHC3O6Rcjs.useBooleanEvent.call(void 0, renderOnResize);
  _react.useEffect.call(void 0, () => {
...
var CollectionRenderer = _QYN73JUBcjs.forwardRef.call(void 0, function CollectionRenderer2(props) {
