...
var usePopoverArrow = _QYN73JUBcjs.createHook.call(void 0, 
  function usePopoverArrow2({
    ...
    const context = _D4JBVI4Fcjs.usePopoverContext.call(void 0, );
    store = store || context;
    _misc.invariant.call(void 0, 
      store,
      process.env.NODE_ENV !== "production" && "PopoverArrow must be wrapped in a Popover component."
    );
    const dir = _JRPZ5DZLcjs.useStoreState.call(void 0, 
      store,
      (state) => state.currentPlacement.split("-")[0]
    );
    const maskId = _HAHC3O6Rcjs.useId.call(void 0, );
    ...
    props = {
      ...
      "aria-hidden": true,
      ...props,
      ref: _HAHC3O6Rcjs.useMergeRefs.call(void 0, store.setArrowElement, props.ref),
      style: {
        position: "absolute",
        fontSize: size,
        width: "1em",
...
var PopoverArrow = _QYN73JUBcjs.memo.call(void 0, 
  _QYN73JUBcjs.forwardRef.call(void 0, function PopoverArrow2(props) {
