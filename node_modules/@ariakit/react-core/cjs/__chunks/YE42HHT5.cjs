...
var _YZCSZZOHcjs = require('./YZCSZZOH.cjs');



var _D4JBVI4Fcjs = require('./D4JBVI4F.cjs');
...
var usePopover = _QYN73JUBcjs.createHook.call(void 0, 
  function usePopover2({
    ...
    const context = _D4JBVI4Fcjs.usePopoverProviderContext.call(void 0, );
    store = store || context;
    _misc.invariant.call(void 0, 
      store,
      process.env.NODE_ENV !== "production" && "Popover must receive a `store` prop or be wrapped in a PopoverProvider component."
    );
    const arrowElement = _JRPZ5DZLcjs.useStoreState.call(void 0, store, "arrowElement");
    const anchorElement = _JRPZ5DZLcjs.useStoreState.call(void 0, store, "anchorElement");
    const disclosureElement = _JRPZ5DZLcjs.useStoreState.call(void 0, store, "disclosureElement");
    const popoverElement = _JRPZ5DZLcjs.useStoreState.call(void 0, store, "popoverElement");
    const contentElement = _JRPZ5DZLcjs.useStoreState.call(void 0, store, "contentElement");
    const placement = _JRPZ5DZLcjs.useStoreState.call(void 0, store, "placement");
    const mounted = _JRPZ5DZLcjs.useStoreState.call(void 0, store, "mounted");
    const rendered = _JRPZ5DZLcjs.useStoreState.call(void 0, store, "rendered");
    ...
    const { portalRef, domReady } = _HAHC3O6Rcjs.usePortalRef.call(void 0, portal, props.portalRef);
    const getAnchorRectProp = _HAHC3O6Rcjs.useEvent.call(void 0, getAnchorRect);
    const updatePositionProp = _HAHC3O6Rcjs.useEvent.call(void 0, updatePosition);
    ...
    props = _HAHC3O6Rcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _D4JBVI4Fcjs.PopoverScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = {
    ...
    props = _YZCSZZOHcjs.useDialog.call(void 0, {
      store,
      modal,
      portal,
      preserveTabOrder,
...
var Popover = _YZCSZZOHcjs.createDialogComponent.call(void 0, 
  _QYN73JUBcjs.forwardRef.call(void 0, function Popover2(props) {
    const htmlProps = usePopover(props);
    return _QYN73JUBcjs.createElement.call(void 0, TagName, htmlProps);
  }),
  _D4JBVI4Fcjs.usePopoverProviderContext
);
