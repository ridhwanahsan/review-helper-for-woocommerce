...
var useCompositeTypeahead = _QYN73JUBcjs.createHook.call(void 0, function useCompositeTypeahead2({ store, typeahead = true, ...props }) {
...
var CompositeTypeahead = _QYN73JUBcjs.forwardRef.call(void 0, function CompositeTypeahead2(props) {
