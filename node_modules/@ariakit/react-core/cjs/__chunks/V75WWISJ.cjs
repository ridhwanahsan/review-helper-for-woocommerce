...
var _ZDWFUT2Ocjs = require('./ZDWFUT2O.cjs');
...
var useCommand = _QYN73JUBcjs.createHook.call(void 0, 
  function useCommand2({ clickOnEnter = true, clickOnSpace = true, ...props }) {
    ...
    const [isDuplicate, metadataProps] = _HAHC3O6Rcjs.useMetadataProps.call(void 0, props, symbol, true);
    ...
    const onKeyUp = _HAHC3O6Rcjs.useEvent.call(void 0, (event) => {
    ...
    props = _ZDWFUT2Ocjs.useFocusable.call(void 0, props);
    return props;
  }
);
var Command = _QYN73JUBcjs.forwardRef.call(void 0, function Command2(props) {
