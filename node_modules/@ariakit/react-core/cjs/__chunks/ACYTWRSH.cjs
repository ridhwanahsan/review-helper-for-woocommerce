...
var _65WUUKJHcjs = require('./65WUUKJH.cjs');
...
function findById(items, id, baseId) {
  return items.findIndex((item, index) => {
    var _a;
    const itemId = _65WUUKJHcjs.getCollectionRendererItemId.call(void 0, item, index, baseId);
...
function useCompositeRenderer({
  ...
  store = store || context;
  const orientation = _JRPZ5DZLcjs.useStoreState.call(void 0, 
    store,
  ...
  const items = _JRPZ5DZLcjs.useStoreState.call(void 0, store, (state) => {
    var _a;
  ...
  const activeId = _JRPZ5DZLcjs.useStoreState.call(void 0, store, "activeId");
  ...
  return _65WUUKJHcjs.useCollectionRenderer.call(void 0, {
    id,
    store,
    orientation,
    persistentIndices,
...
var CompositeRenderer = _QYN73JUBcjs.forwardRef.call(void 0, function CompositeRenderer2(props) {
