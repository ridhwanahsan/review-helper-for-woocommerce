...
var TagName = "h1";
var useHeading = _QYN73JUBcjs.createHook.call(void 0, 
  function useHeading2(props) {
    const ref = _react.useRef.call(void 0, null);
    const level = _react.useContext.call(void 0, _JLMLKTUBcjs.HeadingContext) || 1;
    const Element = `h${level}`;
    const tagName = _HAHC3O6Rcjs.useTagName.call(void 0, ref, Element);
...
var Heading = _QYN73JUBcjs.forwardRef.call(void 0, function Heading2(props) {
