...
var _KTMZUVQIcjs = require('./KTMZUVQI.cjs');
...
function useToolbarStoreProps(store, update, props) {
  return _KTMZUVQIcjs.useCompositeStoreProps.call(void 0, store, update, props);
}
function useToolbarStore(props = {}) {
  const [store, update] = _JRPZ5DZLcjs.useStore.call(void 0, Core.createToolbarStore, props);
