...
function useStoreProps(store, props, key, setKey) {
  ...
  const propsRef = _HAHC3O6Rcjs.useLiveRef.call(void 0, { value, setValue });
...
function useStore(createStore, props) {
  ...
  _HAHC3O6Rcjs.useSafeLayoutEffect.call(void 0, () => _store.init.call(void 0, store), [store]);
  ...
  const updateStore = _HAHC3O6Rcjs.useEvent.call(void 0, () => {
